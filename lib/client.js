...
TableStore.Client = inherit({
  ...
  listStream: function (params, callback) {
    this.makeRequest('listStream', params, callback);
  },
  describeStream: function (params, callback) {
    this.makeRequest('describeStream', params, callback);
  },
  getShardIterator: function (params, callback) {
    this.makeRequest('getShardIterator', params, callback);
  },
  getStreamRecord: function (params, callback) {
    this.makeRequest('getStreamRecord', params, callback);
  }
  /**********************************  数据操作 结束 ******************************************/
});